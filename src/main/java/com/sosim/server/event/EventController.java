...
public class EventController {
    ...
    public ResponseEntity<?> changePaymentTypes(@AuthenticationPrincipal AuthUser authUser, @RequestBody ClientEventStatusUpdateReq request) {
        ...
        ClientEventStatusUpdateInfo response = new ClientEventStatusUpdateInfo(
            request.getEventIdList(),
            ClientEventInfo.toSituation(com.sosim.server.type.PaymentType.getType(request.getSituation()))
        );
